...
I'm a Full Stack Developer and an Illustrator who's been studying art for 8 years. I love playing video games in my spare time! 
...
#### KAKIOKI
###### End-to-end Encrypted chat web-application built with React + TypeScript
[![GitHub](https://img.shields.io/badge/GitHub-%23121011.svg?logo=github&logoColor=white)]([#](https://github.com/Neuwair/kakioki))
> Real-time chat application with end-to-end encryption using Libsodium, and real-time messaging and presence via Ably.<br>
Built with React, Next.js, and TypeScript, and deployed on Vercel.
<img width="800" height="400" alt="kakioki2 BsPrTtfi" src="https://github.com/user-attachments/assets/bba9dd36-729f-4d8f-8215-6ac5ebca09b2" />
<br>
<img width="800" height="500" alt="kakioki1 BfSSiWai" src="https://github.com/user-attachments/assets/ce8207b3-44bb-47be-b8fe-e4e3ee3b7f5f" />

#### AeroSocial
[![GitHub](https://img.shields.io/badge/GitHub-%23121011.svg?logo=github&logoColor=white)]([#](https://github.com/Neuwair/aero-social))

> Social media MVP built with HTML, CSS, and JavaScript, featuring basic posting, feed rendering, and user interactions,<br>
demonstrating core full-stack fundamentals.
<img width="800" height="700" alt="Untitled-1" src="https://github.com/user-attachments/assets/435be09d-018b-4fef-998d-288172423899" />
